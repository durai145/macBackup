...
app.locals({
  title: 'Global Product Protal Admin'
});
...
app.post('/glbladmin/page/backbone' , function(req,res) {
...
app.get('/glbladmin/service/:id', function(req, res){

console.log('/glbladmin/service/');
/*[
{ USRID: '1',
  GROUPID: '1',
  class: 'ctext',
...
app.get('/rjs/ufi-shim/service/:id', function(req, res){
...
app.post('/rjs/ufi-shim/service/:id', function(req, res){
...
http.createServer(app).listen(3000, function() { console.log('Listening on port %d', "3000"); });
